...
================================================================================
[*] Fitted 5,000 TF-IDF features in 0.25s
[*] Train Matrix Shape: (15984, 5000), Test Matrix Shape: (2000, 5000)

================================================================================
 MODEL 1: TRAINING LINEAR SUPPORT VECTOR MACHINE (LinearSVC C=1.0)
================================================================================
[+] Linear SVM RESULTS (Test Set N=2000):
...
================================================================================
 MODEL 2: TRAINING EXTREME GRADIENT BOOSTING (XGBClassifier 100 Trees)
================================================================================
[+] XGBoost RESULTS (Test Set N=2000):
...
================================================================================
 MODEL 3: TRAINING RANDOM FOREST (RandomForestClassifier 100 Trees)
================================================================================
[+] Random Forest RESULTS (Test Set N=2000):
...
================================================================================
 MODEL 4: TRAINING MULTINOMIAL LOGISTIC REGRESSION (L-BFGS)
================================================================================
...
================================================================================
 MODEL 5: TRAINING PYTORCH BIDIRECTIONAL LSTM (3 EPOCHS)
================================================================================
  [*] Epoch 1/3 -> Train Loss: 1.5686 | Val Acc: 45.65%
  [*] Epoch 2/3 -> Train Loss: 1.1565 | Val Acc: 70.75%
  [*] Epoch 3/3 -> Train Loss: 0.6449 | Val Acc: 79.75%
[+] Bi-LSTM RESULTS (Test Set N=2000):
...
================================================================================
 MODEL 6: TRAINING MULTINOMIAL NAIVE BAYES (MultinomialNB alpha=1.0)
================================================================================
...
```
================================================================================
 EXECUTING N-GRAM & PREPROCESSING PIPELINE ABLATION STUDY
================================================================================
...
```
================================================================================
 EXECUTING CLASS-BALANCING STRATEGIES COMPARISON EXPERIMENT
================================================================================
[*] Training distribution: {0: 4665, 3: 2159, 2: 1298, 5: 571, 4: 1934, 1: 5357}
[*] Surprise class count: 571 samples (3.57%)
...
=====================================================================================
 REPRODUCING TABLE 2: HYPERPARAMETER CONFIGURATIONS
=====================================================================================
Model                               | Hyperparameter Specification                 
-------------------------------------------------------------------------------------
Logistic Regression                 | Solver=L-BFGS, Max Iter=1000, L2 Penalty (C=1.0), Multi-class=multinomial
Linear Support Vector Machine       | Loss=LinearSVC, Max Iter=2000, Penalty=L2 (C=1.0), Multi-class=ovr
Multinomial Naive Bayes             | Additive Laplace Smoothing alpha=1.0, Prior=Empirical Class Probabilities
Random Forest                       | Trees (M)=100 Decision Trees, Splitting Criterion=Gini, Max Features=sqrt(V)=70, Bootstrap=True
XGBoost                             | Estimators=100 GBDT Trees, Max Depth=6, Learning Rate eta=0.30, Objective=multi:softprob
Bidirectional LSTM                  | Seq Length=50, Embedding Dim=128, Hidden Dim=64 (Bi-LSTM -> 128), Dropout=0.30, Batch Size=64, Epochs=3, Optimizer=Adam (lr=0.001)
=====================================================================================
```
